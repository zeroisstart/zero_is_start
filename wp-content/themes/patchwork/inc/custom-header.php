...
function patchwork_custom_header_setup() {
	...
	// Add a filter to patchwork_header_image_width and patchwork_header_image_height to change these values.
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'patchwork_header_image_width', 650 ) );
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'patchwork_header_image_height', 150 ) );

	// Turn on random header image rotation by default.
	add_theme_support( 'custom-header', array( 'random-default' => true ) );

	// Add a way for the custom header to be styled in the admin panel that controls custom headers
	add_custom_image_header( 'patchwork_header_style', 'patchwork_admin_header_style', 'patchwork_admin_header_image' );
}
 ...
 *
 * Referenced via add_custom_image_header() in patchwork_setup().
 *
 * @since Patchwork 1.0
 */
